...
const tempLogin = (email, password) => {
  ...
  let tempStoredHash =
    "$2a$10$qya34SBSGDOPVP2MFyl1xuFotW.gjs8FrNiPwIrSbaTOXIu3eXeb.";
...
// CREATE
const create = async (firstName, lastName, password, email, role) => {
...
//   }
//   const deletedUser = await bandsCollection.findOneAndDelete({
//     _id: new ObjectId(id),
//   });
